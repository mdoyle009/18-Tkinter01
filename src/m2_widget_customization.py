...
label = tk.Label(window, text="My Custom Label", fg="purple", bg="green", width=15, height=3)
label.pack()
button =tk.Button(window, text="My Custom Button", fg="white", bg="black", width=12, height=2)
button.pack()
entry = tk.Entry(window, width=20)
entry.insert(0, "Matthew Doyle")
entry.pack()
window.mainloop()
